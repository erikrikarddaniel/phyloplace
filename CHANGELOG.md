...
### `Added`
    ...
    - [#NN](https://github.com/nf-core/phyloplace/pull/NN) - Derive taxonomy from `--refseqfile` FASTA headers (GTDB single-file style) when `--taxonomy` is not given, instead of skipping taxonomic classification entirely ([#66](https://github.com/nf-core/phyloplace/issues/66)) (by @erikrikarddaniel)
