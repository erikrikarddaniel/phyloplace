...
### `Added`
    ...
    - [#NN](https://github.com/nf-core/phyloplace/pull/NN) - Alignment coordinates, lengths and coverage for each hit in the ranked `hmmsearch` summary, when `--save_domtblout` is set ([#70](https://github.com/nf-core/phyloplace/issues/70)) (by @erikrikarddaniel)
